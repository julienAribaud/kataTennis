...
class ReportParsersTest {
    ...
    public void gameStatus_player1Score3_AND_Player2Score2_SHOULD_display_4030(){
        ...
        assertThat(ReportParsers.gameStatus(game)).isEqualTo("Current game status : 40-30");
    }
    ...
    public void gameStatus_player1Score1_AND_Player2Score1_SHOULD_display_1515(){
        ...
        assertThat(ReportParsers.gameStatus(game)).isEqualTo("Current game status : 15-15");
    }
    ...
    public void gameStatus_deuce_SHOULD_display_deuce(){
        ...
        assertThat(ReportParsers.gameStatus(game)).isEqualTo("Current game status : deuce");
    }
    ...
    public void gameStatus_advantage_SHOULD_display_advantage(){
        ...
        assertThat(ReportParsers.gameStatus(game)).isEqualTo("Current game status : advantage");
    }
}